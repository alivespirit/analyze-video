...
- `GET /api/events/latest?since=` — away/back events with current home/away status (computed from the latest event by real-world event time, not log/processing order)
